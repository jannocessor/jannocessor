...
public class RulesFactory {
	...
	public static RuleExecutor createRulesService(Configuratîr config,
			PathLocator paths) throws JannocessorException {
		return new RulesServiceImpl(config, paths);
	}
