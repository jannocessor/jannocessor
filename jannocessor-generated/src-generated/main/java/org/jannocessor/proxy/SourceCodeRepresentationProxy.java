...
public class SourceCodeRepresentationProxy implements JavaCodeModel {

    private JavaCodeModel adapter;

    private SourceCodeRepresentationData data;

    public SourceCodeRepresentationProxy(JavaCodeModel adapter, SourceCodeRepresentationData data) {
