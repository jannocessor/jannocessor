...
abstract class JavaExecutableAdapter extends ElementAdapter implements JavaExecutable {

    private final ExecutableElement executable;

    public JavaExecutableAdapter(ExecutableElement executable, Elements elementUtils, Types typeUtils) {
    ...
    public PowerList<JavaTypeParameter> getTypeParameters() {
        ...
        for (TypeParameterElement typeParameter : executable.getTypeParameters()) {
            JavaTypeParameter adapter = getElementAdapter(typeParameter, JavaTypeParameter.class);
    ...
    public PowerList<JavaParameter> getParameters() {
        ...
        for (VariableElement variable : executable.getParameters()) {
            JavaParameter adapter = getElementAdapter(variable, JavaParameter.class);
            adapters.add(adapter);
        }
